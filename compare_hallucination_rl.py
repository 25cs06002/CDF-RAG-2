...
RESULTS_FILE = "evaluation_metrics_results_rl_deterministic.csv"
GOLD_FILE = "evaluate_batch_with_metrics_rl_gold.csv"
OUTPUT_FILE = "evaluation_metrics_with_rl.csv"
